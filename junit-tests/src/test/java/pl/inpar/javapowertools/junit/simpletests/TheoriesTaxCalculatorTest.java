...
public class TheoriesTaxCalculatorTest {
    ...
    @DataPoint
    public static double INCOME_1 = 100.0;
    @DataPoint
    public static double INCOME_2 = 500.0;
    @DataPoint
    public static double INCOME_3 = 3000.0;
    @DataPoint
    public static double INCOME_4 = 6000.0;
    @DataPoint
    public static double INCOME_5 = 23456.0;
